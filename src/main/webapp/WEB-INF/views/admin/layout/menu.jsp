        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="/admin/book"><i class="fa fa-fw fa-table"></i>Book Table</a>
                    </li>
                     <li>
                        <a href="/admin/user"><i class="fa fa-fw fa-table"></i>User Table</a>
                    </li>
                     <li>
                        <a href="#"><i class="fa fa-fw fa-table"></i>Category Table</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-fw fa-edit"></i>Thêm Category</a>
                    </li>
