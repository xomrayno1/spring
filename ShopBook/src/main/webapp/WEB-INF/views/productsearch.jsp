...
<div class="container">
			<div class="products">
					...
					<li ><a href="/tim-kiem/${pre}?search=${search}"><i></i></a></li>
					...
					<li class="arrow"><a href="/tim-kiem/${value}?search=${search}">${value}</a></li>
					</c:if>
					...
					<li ><a href="/tim-kiem/${next}?search=${search}"><i  class="next"> </i></a></li>
				    </ul>
